...
import { decodePost, POST_V3_SCHEMA_URI } from "@vco/vco-schemas";
import { decodeEnvelopeProto } from "@vco/vco-core";

describe("buildMessage / decodeMessage with Post schema", () => {
  it("buildMessage encodes payload as a valid Post v3 protobuf", async () => {
    ...
    expect(post.schema).toBe(POST_V3_SCHEMA_URI);
