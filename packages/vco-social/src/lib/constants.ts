...
export const NETWORK_ID = "vco-mainnet";

export const GLOBAL_SOCIAL_CHANNEL = "vco://channels/social/global";
...
export const DEFAULT_POW_DIFFICULTY = 10;
export const MAX_BLOB_COUNT = 200;
export const FEED_PAGE_SIZE = 20;

export const BOOTSTRAP_NODES: string[] = []; // Configure real nodes here
