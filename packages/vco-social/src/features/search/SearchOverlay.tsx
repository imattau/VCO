...
export function SearchOverlay() {
  ...
  const mockUsers = [
    ...
    { name: 'Decentralized Dave', did: 'did:vco:dave...456' },
  ];

  const mockTags = ['#VCO', '#web3', '#cryptography', '#swarm'];
                   ...
                   {mockTags.map(tag => (
                     ...
                     >
                        ...
                        <div>
                           ...
                           <div className="text-[10px] text-zinc-500">1.2k Verifiable Objects</div>
                        </div>
                     </button>
                   ))}
                </div>
                   ...
                   {mockUsers.filter(u => u.name.toLowerCase().includes(query.toLowerCase())).map(user => (
                     ...
                     >
                        ...
                        <div className="flex-1 min-w-0">
                           ...
                           <div className="text-[10px] text-zinc-500 font-mono truncate">{user.did}</div>
                        </div>
                     </button>
                   ))}
                </div>
